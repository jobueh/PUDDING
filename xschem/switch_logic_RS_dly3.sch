...
N 200 -170 260 -170 {lab=ON_N}
N 200 160 260 160 {lab=ON}
...
C {opin.sym} 260 160 0 0 {name=p4 lab=OFF_N}
C {opin.sym} 260 -170 0 0 {name=p5 lab=ON_N}
...
C {sg13g2_stdcells/sg13g2_buf_1.sym} 160 -170 0 0 {name=x5 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_buf_1.sym} 160 160 0 0 {name=x6 VDD=VDD VSS=VSS prefix=sg13g2_ }
