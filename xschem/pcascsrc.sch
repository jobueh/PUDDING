...
N 520 -360 520 -240 {lab=NWELL}
N 500 -420 500 -390 {lab=VDD}
N 500 -330 500 -270 {lab=drain}
N 500 -210 500 -180 {lab=Iout}
N 500 -360 520 -360 {lab=NWELL}
N 500 -240 520 -240 {lab=NWELL}
N 360 -420 500 -420 {lab=VDD}
N 360 -460 520 -460 {lab=NWELL}
N 520 -460 520 -360 {lab=NWELL}
...
C {iopin.sym} 360 -460 0 1 {name=p6 lab=NWELL}
